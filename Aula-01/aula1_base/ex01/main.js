...
var texto = "Meu nome é Danilson Sanches";
...
var btn_tarefa = document.querySelector("#tarefasBtn");
...
var output_3 = document.querySelector("#output-3");
//3. Dentro da função, atribui o parâmetro à div usando innerHTML.
function tipada(texto) {
...
var output_4 = document.querySelector("#output-4");
function tresCaracteres(texto) {
    if (texto.length >= 3) {
...
var output_5 = document.querySelector("#output-5");
...
var output_6 = document.querySelector("#output-6");
...
var output_7 = document.querySelector("#output-7");
if (output_7) {
...
var idade;
idade = 43;
var output_8 = document.querySelector("#output-8");
